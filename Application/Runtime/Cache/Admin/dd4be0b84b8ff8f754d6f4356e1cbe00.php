        ...
        <div class="am-popup am-radius" id="data-save-win">
			<div class="am-popup-inner">
				<div class="am-popup-hd">
					<h4 class="am-popup-title" data-add-title="<?php echo L('class_add_name');?>" data-edit-title="<?php echo L('class_edit_name');?>"><?php echo L('class_add_name');?></h4>
					<span data-am-modal-close
					class="am-close">&times;</span>
				</div>
				<div class="am-popup-bd">
					<!-- form start -->
					<form class="am-form form-validation admin-save" action="<?php echo U('Admin/Class/Save');?>" method="POST" request-type="ajax-reload" request-value="">
...
<!-- footer end -->
<script>
	Tree(0, "<?php echo U('Admin/Class/GetNodeSon');?>", 0);
</script>